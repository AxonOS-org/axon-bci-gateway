...
Security reports for `axon-bci-gateway` should be sent to:

security@axonos.org

Relevant issues include:

- unsafe processing of acquisition streams;
- malformed OSC or LSL data handling;
- path traversal or file handling problems;
